...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    // Opsional: Jika Anda ingin menggunakan user info, Anda bisa type assert di sini juga
    // const userInfo = await userinfoResponse.json() as { sub: string; name: string; picture: string; };
} catch (error) {
