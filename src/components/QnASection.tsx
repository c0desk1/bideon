  ...
  return (
    <section className="container mx-auto px-4 py-16">
      <div className="text-left mb-10">
        ...
        <a href="/qna" className="inline-block mt-4 px-4 py-2 rounded-lg border border-white/10 bg-white/5 text-white text-sm font-medium hover:bg-white/10 transition-colors">Lihat Semua Tanya Jawab</a>
      </div>
      <QnAList />
    </section>
  );
